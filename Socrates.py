...
class SocratesApp:
    ...
    def print_help(self):
        print()
        print("=" * 80)
        print("  AVAILABLE COMMANDS - COPY & PASTE THESE EXAMPLES:")
        print("=" * 80)
        print()
        print("  STEP 1 - CREATE ACCOUNT:")
        print("    register user@test.com password123")
        print()
        print("  STEP 2 - LOGIN:")
        print("    login user@test.com password123")
        print()
        print("  STEP 3 - CREATE PROJECT:")
        print("    create-project MyProject \"This is my test project\"")
        print()
        print("  STEP 4 - LIST YOUR PROJECTS:")
        print("    projects")
        print()
        print("  STEP 5 - CREATE SESSION (copy PROJECT_ID from step 4):")
        print("    create-session 1234abcd-5678-90ef-ghij-klmnopqrstuv")
        print()
        print("  STEP 6 - CHAT (copy SESSION_ID from step 5):")
        print("    chat 9999xxxx-yyyy-zzzz-aaaa-bbbbccccdddd \"What should we build?\"")
        print()
        print("  OTHER COMMANDS:")
        print("    test                           - Run all tests")
        print("    test 7                         - Run Phase 7 tests only")
        print("    health                         - Check if API is working")
